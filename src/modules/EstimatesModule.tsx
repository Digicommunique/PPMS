...
export default function EstimatesModule() {
  ...
  useEffect(() => {
    if (currentEstimate.costs) {
      ...
      const profit = subtotal * (Number(profitMargin) / 100);
      setTotalCost(subtotal);
      setFinalPrice(subtotal + profit);
    }
  }, [currentEstimate.costs]);
                ...
                <form id="est-form" onSubmit={handleSaveEstimate} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-xl space-y-6">
                    ...
                    <div className="pt-4 border-t border-gray-100 space-y-4">
                       ...
                       {/* Summary Area */}
                       <div className="bg-primary p-6 rounded-3xl text-white shadow-2xl space-y-4 relative overflow-hidden">
                          <div className="flex justify-between items-center relative z-10 transition-all">
                             <span className="text-xs font-bold opacity-60 uppercase tracking-widest">Base Cost</span>
                          ...
                          <div className="flex justify-between items-end relative z-10 border-t border-white/10 pt-4">
                             <span className="text-sm font-black uppercase tracking-[0.2em]">Final Price</span>
                             <div className="text-right">
                               <span className="text-[10px] block opacity-40 font-bold mb-1">Custom Pricing Override</span>
                               <span className="text-3xl font-black text-accent-cyan">₹{finalPrice.toLocaleString()}</span>
                             </div>
                          </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="relative bg-white shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl p-10 font-sans">
              ...
              <div className="space-y-4 mb-8">
                <h4 className="text-[10px] font-black uppercase text-secondary tracking-widest border-b border-gray-100 pb-2">Costing Breakdown</h4>
                ...
                <div className="flex justify-between items-center p-4 bg-accent-amber/5 border border-accent-amber/10 rounded-xl mt-4">
                  <span className="text-xs font-black text-primary uppercase">Profit Margin Applied</span>
                  <span className="text-lg font-black text-accent-amber">{selectedEstimate.costs?.profitMargin}%</span>
                </div>
              </div>
