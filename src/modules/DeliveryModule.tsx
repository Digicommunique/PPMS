...
import { 
  ...
  MoreVertical, Calendar, CheckSquare, Fingerprint, ShieldCheck, ExternalLink
} from 'lucide-react';
...
const mockDeliveries: Delivery[] = [
  { 
    id: 'DSP-001', 
    jobId: 'JC-013', 
    jobTitle: 'GANITH Textbook Cover', 
  ...
  { 
    id: 'DSP-003', 
    jobId: 'JC-010', 
    jobTitle: 'Company Annual Report', 
...
export default function DeliveryModule() {
  ...
  const filteredDeliveries = deliveries.filter(d => {
    const matchesSearch = d.jobTitle.toLowerCase().includes(searchTerm.toLowerCase()) || d.customer.toLowerCase().includes(searchTerm.toLowerCase()) || d.id.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
           <button className="bg-white border border-gray-200 text-primary px-5 py-3 rounded-xl font-bold flex items-center gap-2 hover:bg-gray-50 transition-all shadow-sm">
            <MapIcon size={20} className="text-accent-cyan" /> Route Planner
           </button>
           <button 
                  ...
                  <div key={d.id} className="p-6 hover:bg-gray-50/30 transition-all group">
                     <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        <div className="flex items-start gap-4">
                           <div className={`p-4 rounded-2xl shadow-inner ${d.status === 'Delivered' ? 'bg-success/10 text-success' : 'bg-primary/5 text-primary'}`}>
                              {d.mode === 'In-house Rider' ? <Bike size={24} /> : d.mode === 'Lorry' ? <Truck size={24} /> : <Package size={24} />}
                           </div>
                           <div className="space-y-1">
                              <div className="flex items-center gap-2">
                                 <h4 className="font-bold text-primary group-hover:text-accent-cyan transition-colors">{d.jobTitle}</h4>
                        ...
                        <div className="flex flex-wrap items-center gap-6 lg:gap-12 pl-14 lg:pl-0">
                           ...
                           <div className="flex items-center gap-4">
                              ...
                              <button className="p-2.5 hover:bg-white rounded-xl transition-all shadow-sm bg-gray-50 group-hover:bg-primary group-hover:text-white">
        ...
        <div className="space-y-6">
           <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group">
              <div className="relative z-10">
                ...
                <button className="w-full mt-8 py-3 bg-gray-50 text-[10px] font-black uppercase tracking-widest text-secondary rounded-xl hover:bg-primary hover:text-white transition-all border border-gray-100 flex items-center justify-center gap-2">
           ...
           <div className="p-6 bg-gradient-to-br from-primary to-primary-dark rounded-3xl text-white shadow-xl">
              <div className="flex items-center gap-3 mb-4">
                 <div className="p-2 bg-white/10 rounded-xl">
                    <MapIcon size={20} />
                 </div>
                 <span className="text-xs font-black uppercase tracking-widest">Fleet Live</span>
              </div>
              <div className="space-y-3">
                 <div className="flex justify-between items-center">
                    <span className="text-[10px] font-bold opacity-60">Active Riders</span>
                    <span className="text-sm font-black">04 / 06</span>
                 </div>
                 <div className="flex justify-between items-center">
                    <span className="text-[10px] font-bold opacity-60">Pending POD</span>
            ...
            >
              <div className="p-8 border-b border-gray-100 flex items-center justify-between bg-primary text-white">
                <div className="flex items-center gap-4">
                   ...
                   <div>
                     ...
                     <p className="text-white/60 text-xs uppercase tracking-widest font-bold mt-1">Schedule Logistic Route & Mode</p>
                   </div>
                </div>
              ...
              <form id="dispatch-form" onSubmit={handleScheduleDispatch} className="p-10 space-y-8 bg-gray-50/20 max-h-[70vh] overflow-y-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                   ...
                   <div className="space-y-2">
                     ...
                     <div className="relative">
                       ...
                       <input name="customer" required placeholder="Type Customer Name" className="w-full px-5 py-4 bg-white border border-gray-100 rounded-2xl outline-none focus:ring-2 focus:ring-accent-cyan shadow-sm font-bold text-sm" />
                     </div>
                   </div>
                ...
                <div className="space-y-2">
                   ...
                   <textarea name="address" required placeholder="Floor, Building, Area, Pincode" className="w-full px-5 py-4 bg-white border border-gray-100 rounded-2xl outline-none focus:ring-2 focus:ring-accent-cyan h-28 shadow-sm text-sm font-medium" />
                </div>
