...
export default function SupportModule() {
  ...
  const faq = [
    { q: "How to sync with Tally?", a: "Go to Accounts > Tally Integration tab. Ensure TallyAPIConnector is running on your local machine and your Tally port is set to 9000." },
